...
public class MarsCity {
	...
	/**
	 * Get instance mars city.
	 *
	 * @return the mars city
	 */
	public static MarsCity getInstance(){
		if (marsCity == null) {
			marsCity = new MarsCity();
		}
		return marsCity;
	}
	...
	/**
	 * Gets stations by lane.
	 *
	 * @param lane the lane
	 * @return the stations by lane
	 */
	...
	public void fillStations() {
		...
		lane.add(new StationInfo(24, "City Centre", true, LANE.BLUE, LANE.GREEN));
		...
		lane.add(new StationInfo(29, "Boxing Avenue", true, LANE.BLUE, LANE.RED));
		lane.add(new StationInfo(30, "West End", false, LANE.BLUE));
		// add to map
		stationMap.put(LANE.BLUE, lane);
		// Fill BLACK lane
		lane = new ArrayList<>();
		lane.add(new StationInfo(31, "East End", true, LANE.BLACK, LANE.BLUE));
		...
		lane.add(new StationInfo(37, "South Park", true, LANE.BLACK, LANE.GREEN));
		lane.add(new StationInfo(38, "Newton Bath Tub", false, LANE.BLACK));
		lane.add(new StationInfo(39, "Einstein Lane", false, LANE.BLACK));
		lane.add(new StationInfo(40, "Neo Lane", true, LANE.BLACK, LANE.RED));
		// add to map
		stationMap.put(LANE.BLACK, lane);
		// Fill YELLOW lane
		lane = new ArrayList<>();
		lane.add(new StationInfo(41, "Green Cross", true, LANE.YELLOW, LANE.GREEN));
		...
		lane.add(new StationInfo(45, "Morpheus Lane", true, LANE.YELLOW, LANE.RED));
